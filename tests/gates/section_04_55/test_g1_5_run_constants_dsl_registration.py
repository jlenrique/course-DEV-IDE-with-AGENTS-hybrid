...
POLL_SURFACE = Path("app/gates/section_04_55/poll_surface.py")
MODULE_NAME = "app.gates.section_04_55.poll_surface"
...
def test_run_constants_surface_has_exactly_one_module_level_parity_contract() -> None:
