...
1. Default resolution (no override): tier_request="reasoning" + Irene's
   `model_config.yaml::default_model = "gpt-5"` → resolves to gpt-5 at
   resolution_level="per_specialist".
2. Per-call override: `make_chat_model(per_call_override="gpt-5-nano")`
   → resolves to gpt-5-nano at resolution_level="per_call".
"""
