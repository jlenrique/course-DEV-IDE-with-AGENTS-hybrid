...
def test_kira_default_resolution_resolves_to_gpt_5_haiku() -> None:
    handle = make_chat_model(specialist_id="kira", tier_request="fast")
...
def test_kira_per_call_override_wins() -> None:
