...
def test_texas_default_resolution_resolves_to_gpt_5_haiku() -> None:
    handle = make_chat_model(specialist_id="texas", tier_request="fast")
...
def test_texas_per_call_override_wins() -> None:
    handle = make_chat_model(
        specialist_id="texas",
        tier_request="fast",
        per_call_override="gpt-5.4",
    )
