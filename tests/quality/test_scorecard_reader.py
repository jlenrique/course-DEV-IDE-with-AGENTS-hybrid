...
def test_canonical_dimension_keys_constant() -> None:
    ...
    # Q3.2 added tracker_coherence (Dimension 6); Q3.3 adds lane_discipline (Dimension 7) — each
    # in lockstep with registering its honesty-pin (GL-6). The canonical universe now names all
    # seven dimensions.
