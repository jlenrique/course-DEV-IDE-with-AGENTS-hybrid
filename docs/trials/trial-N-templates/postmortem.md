# Trial-N Postmortem (Template)

> **Template usage:** copy this file to `docs/trials/trial-N/postmortem.md`. **Shape A is mandatory at trial-close (15 min); Shape B is deferred 48h** (structured findings; recovered-operator energy required). Sally pre-S3 review depletion-empathy beat.
