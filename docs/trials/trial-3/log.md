...
> **This is the trial-3 skeleton; fill in place.** Originally copied from `docs/trials/trial-N-templates/log.md`. Fill DURING the trial OR compile from runtime artifacts immediately after. Append-only timeline; minimal interpretation, maximum fidelity. Postmortem interprets; log records.
