# G2C — Operator Reference

**Use this doc when:** you've received a paused-at-G2C notification from a trial and need to author a verdict file.
...
```json
{
  ...
  "card_id": "<uuid matching the decision-card-G2C.json>",
  "verb": "approve" | "edit" | "reject",
  "gate_id": "G2C",
  "decision_card_digest": "<sha256 hex from decision-card-G2C.json>",
...
```json
{
  ...
  "card_id": "<from decision-card-G2C.json>",
  "verb": "approve",
  "gate_id": "G2C",
  "decision_card_digest": "<from decision-card-G2C.json>",
  "operator_id": "juanl",
  "edit_payload": null,
  "reject_reason": null,
  "revise_count": 0,
...
Run: `python -m app.marcus.cli.gate_shims.g2c_shim --trial-id <uuid> --verdict-file path/to/verdict.json --operator-id juanl`.
...
- **exit 1** — RuntimeError: trial-id mismatch, or trial not paused at G2C, or downstream resume failure. Inspect stderr for the message.
...
**Gate label:** Storyboard A + Gate 2 Approval (Gary winner authorization)
