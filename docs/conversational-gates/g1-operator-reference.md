# G1 — Operator Reference

**Use this doc when:** you've received a paused-at-G1 notification from a trial and need to author a verdict file.
...
```json
{
  ...
  "card_id": "<uuid matching the decision-card-G1.json>",
  "verb": "approve" | "edit" | "reject",
  "gate_id": "G1",
  "decision_card_digest": "<sha256 hex from decision-card-G1.json>",
...
```json
{
  ...
  "card_id": "<from decision-card-G1.json>",
  "verb": "approve",
  "gate_id": "G1",
  "decision_card_digest": "<from decision-card-G1.json>",
  "operator_id": "juanl",
  "edit_payload": null,
  "reject_reason": null,
  "revise_count": 0,
...
Run: `python -m app.marcus.cli.gate_shims.g1_shim --trial-id <uuid> --verdict-file path/to/verdict.json --operator-id juanl`.
...
**Gate label:** Ingestion Quality Gate + Irene Packet (Vera 6-dim rubric)
