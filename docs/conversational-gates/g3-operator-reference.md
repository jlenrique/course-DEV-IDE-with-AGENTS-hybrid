# G3 — Operator Reference

**Use this doc when:** you've received a paused-at-G3 notification from a trial and need to author a verdict file.
...
```json
{
  ...
  "card_id": "<uuid matching the decision-card-G3.json>",
  "verb": "approve" | "edit" | "reject",
  "gate_id": "G3",
  "decision_card_digest": "<sha256 hex from decision-card-G3.json>",
...
```json
{
  ...
  "card_id": "<from decision-card-G3.json>",
  "verb": "approve",
  "gate_id": "G3",
  "decision_card_digest": "<from decision-card-G3.json>",
  "operator_id": "juanl",
  "edit_payload": null,
  "reject_reason": null,
  "revise_count": 0,
...
Run: `python -m app.marcus.cli.gate_shims.g3_shim --trial-id <uuid> --verdict-file path/to/verdict.json --operator-id juanl`.
...
- **exit 1** — RuntimeError: trial-id mismatch, or trial not paused at G3, or downstream resume failure. Inspect stderr for the message.
...
**Gate label:** Gate 3 - Lock Pass 2 Package (storyboard B HIL approval)
