...
**Date:** 2026-06-19 · **Last updated:** 2026-06-30 (**RECONCILED forward** — the braid COMPLETED and three further arcs shipped since 2026-06-24; live frontier is now the **Concierge Production Substrate arc**, fidelity-firewalled)
...
> - **(4) CONCIERGE PRODUCTION SUBSTRATE arc — CURRENT (opened 2026-06-29; branch `dev/concierge-production-substrate-2026-06-29`).** Goal: prepare the substrate for a TRUE-PRODUCTION concierge run (real deck+motion+workbook+Descript) via 4 legs, with a HARD per-component live-test gate (no mocks). **Leg-1a DONE** (REAL Irene `rhetorical_role` emission — de-inerts the shipped v3 voice channel). An operator-inserted **coverage-assurance interlock (Leg-1)** — a production fidelity firewall that accounts for every source-note point and **fails loud before audio spend** on any uncovered must-cover point — **DUAL-GATE CLOSED 2026-06-30 (path A)**: BLOCK arm proven LIVE ($0 ElevenLabs halt of a real run), COVERED arm proven OFFLINE; **honest scope = numeral/figure-token facet ONLY** (production narration is NOT yet proven figure-faithful → routed to Leg-4). **Leg-1b** (warm_callback authoring + Vera-R7 teeth) is UNBLOCKED and next. **In PARALLEL (conversation-space, 2026-06-30):** a full **Concierge Part-1 narrated lesson was produced + PUBLISHED to Descript** (`web.descript.com/d4c69938-…`, 486s, 9 scenes, every gate honored, ZERO code edits) — a real demonstration the assembled pipeline delivers.
>
> **THE BIG PICTURE (2026-06-30):** the narrated-deck product + the **cited WORKBOOK companion** + the **honest conversational Marcus** are all LIVE and individually proven. The current work is **HARDENING the substrate into a trustworthy, fidelity-firewalled TRUE-PRODUCTION concierge run** (deck+motion+workbook+Descript on prepared substrate). §11 You-are-here / pathway tree / progress table are updated below; **all "braid = frontier" banners dated 2026-06-24 are SUPERSEDED.** Carry-forward honesty debts unchanged: reading-path fresh-naive-holdout still owed; narration-figure-fidelity (production narration substitutes source figures) is the live Leg-4 headline; `sprint-status.yaml` remains the stale Slab-7b/Epic-34 Kanban (the post-braid arcs track via party records + SESSION-HANDOFF, not sprint rows).
...
**(2026-06-30 — CURRENT) The narrated-deck product, the cited WORKBOOK companion, and the honest conversational Marcus are ALL LIVE; the live frontier is HARDENING the substrate into a trustworthy TRUE-PRODUCTION concierge run (deck+motion+workbook+Descript), fidelity-firewalled.** Four arcs closed since the braid green-light below:
...
**You are here →** the narrated-deck product, the **cited WORKBOOK companion**, and the **honest conversational Marcus SPOC** are all **end-to-end live** and individually proven (the braid shipped in full 2026-06-25; the P5 enrichment loop closed; directed voice + enhanced-VO landed). The reading-path classifier work was **superseded by the LLM-first ship** (numbers on the consumed-14; **fresh naive holdout** still the binding generalization gate). The live frontier is the **Concierge Production Substrate arc** — hardening the substrate toward a trustworthy TRUE-PRODUCTION concierge run (deck+motion+workbook+Descript), **fidelity-firewalled**: Leg-1a (rhetorical_role) done; the coverage-assurance interlock (Leg-1) **DUAL-GATE CLOSED path A** (numeral/figure-token facet; narration-figure-fidelity routed to Leg-4); **Leg-1b (warm_callback) is the next build**, then Legs 2/3/4. A full Concierge **Part-1 narrated lesson** was already PUBLISHED to Descript in parallel — proof the assembled pipeline delivers.
...
**Bottom line:** the three product pillars — the **narrated-deck**, the **cited WORKBOOK companion**, and the **honest conversational Marcus SPOC** — are all **end-to-end live and individually proven**. Since the braid green-light, four arcs closed: the **braid COMPLETE** (S5 SPOC `e20aadc`, research live-leg closed), the **P5 enrichment loop CLOSED** (workbook consumes the enriched corpus, byte-verified), the **directed synthesized-voice arc** shipped (directed ElevenLabs + acoustic verification + live Descript), and the **enhanced-VO arc** landed clip-level (v3 tag channel = a real-but-subtle control surface). **The live frontier is the Concierge Production Substrate arc** — hardening the substrate toward a trustworthy TRUE-PRODUCTION concierge run (deck+motion+workbook+Descript), **fidelity-firewalled.** Leg-1a (real `rhetorical_role` emission) is done; the operator-inserted **coverage-assurance interlock (Leg-1)** — a fail-loud-before-spend fidelity firewall over every source-note point — is **DUAL-GATE CLOSED (path A)** with an honest scope (numeral/figure-token facet only; the BLOCK arm is live-proven at $0 ElevenLabs, the COVERED arm offline-proven). The central honest finding it surfaced — **production narration is NOT yet figure-faithful** (it substitutes source figures, and the gate correctly blocks that) — is routed to **Leg-4** with named owners. **Next: Leg-1b (warm_callback) → Leg-2 (motion) → Leg-3 (clustering) → Leg-4 (fidelity ledgers) → the terminal concierge run.** A full Concierge **Part-1 narrated lesson** was already PUBLISHED to Descript (2026-06-30, every gate honored, zero code edits) — concrete proof the assembled pipeline delivers an end-to-end lesson today. (The NEW CYCLE / fully-spawned-party T11 gate continues to earn its keep — this session it caught and prevented an offline-only over-claim, drove an honest live option-C attempt, and produced a dual-gate close that names exactly what is and isn't proven.)
