...
**Date:** 2026-06-19 · **Last updated:** 2026-07-17 (**RECONCILED forward** — Epics 41/42/43 (resume-walk dispatch integrity + operator-surface next-pass + HIL-surface tabular coverage) **all CLOSED**; **master consolidated at `12775df6`**; KG regenerated at `bfefcc1b`; live frontier = the **R2 operator-steered live trial** on `trial/c1m1-p1-2026-07-17`)
**Status:** Canonical orientation doc. Single source of truth for "where the development plan actually stands."

> **2026-07-17 CURRENT SNAPSHOT — YOU ARE HERE NOW.** Branch `trial/c1m1-p1-2026-07-17` (cut off consolidated `master` `12775df6`). The product is the **Marcus-SPOC local runtime orchestrator**: a host-machine runtime that drives an actual app instance; **not** an externally hosted app and not a proofing/concierge vehicle. Since the 2026-07-10 snapshot below, three waves landed and master consolidated:
