...
DEFAULT_ROOTS = (
    ...
    REPO_ROOT / "tests" / "parity" / "test_enrique_activation_contract.py",
    REPO_ROOT / "tests" / "parity" / "test_wanda_activation_contract.py",
    REPO_ROOT / "tests" / "parity" / "test_dan_activation_contract.py",
    REPO_ROOT / "tests" / "specialists" / "tracy",
    REPO_ROOT / "tests" / "specialists" / "gary",
    REPO_ROOT / "tests" / "specialists" / "kira",
    REPO_ROOT / "tests" / "specialists" / "enrique",
    REPO_ROOT / "tests" / "specialists" / "wanda",
    REPO_ROOT / "tests" / "specialists" / "dan",
    ...
    REPO_ROOT / "tests" / "composition" / "test_enrique_to_compositor_chain.py",
    REPO_ROOT / "tests" / "composition" / "test_wanda_to_compositor_chain.py",
    REPO_ROOT / "tests" / "composition" / "test_dan_to_compositor_chain.py",
    REPO_ROOT / "tests" / "end_to_end" / "test_tracy_cache_hit_rate.py",
    REPO_ROOT / "tests" / "end_to_end" / "test_dan_cache_hit_rate.py",
)
FORBIDDEN_MODULES = (
    "gamma_client",
    "kling_client",
