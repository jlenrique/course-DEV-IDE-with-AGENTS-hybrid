...
|------|------------|-------|
| SS | ⚠️ **DISSOLVED / SUPERSEDED** (persona-Cora dissolved, DR-SLAB-1-CLOSE-2026-04-24 DR-2). Session-START is now run directly per the canonical protocol. | See `bmad-session-protocol-session-START.md` (Step 1a coherence gate). Archived procedure: `./references/_archive/session-start-protocol.md` |
| SW | ⚠️ **DISSOLVED / SUPERSEDED** (persona-Cora dissolved, DR-2). Session-WRAPUP is now run directly per the canonical protocol; `next-session-start-here.md` is a GENERATED view (do not hand-write). | See `bmad-session-protocol-session-WRAPUP.md` (Step 0 coherence sweep). Archived procedure: `./references/_archive/session-wrapup-protocol.md` |
