"""Reverse-shim: legacy `marcus.lesson_plan` -> `app.marcus.lesson_plan` (pre-Trial-3 S2 collapse 2026-05-07).

Package-level shim. Sub-modules are individually shimmed to `app.marcus.*` siblings.
"""

from app.marcus.lesson_plan import *  # noqa: F401, F403

import app.marcus.lesson_plan as _src  # noqa: E402
