"""Reverse-shim: legacy `marcus.orchestrator` -> `app.marcus.orchestrator` (pre-Trial-3 S2 collapse 2026-05-07).

Package-level shim. Sub-modules are individually shimmed to `app.marcus.*` siblings.
"""

from app.marcus.orchestrator import *  # noqa: F401, F403

import app.marcus.orchestrator as _src  # noqa: E402
