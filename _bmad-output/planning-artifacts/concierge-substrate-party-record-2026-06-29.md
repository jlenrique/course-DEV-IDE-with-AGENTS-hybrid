...
- **Coverage-assurance interlock: ~90% — offline core committed; F-012 verbatim-guard CLOSED (`fc201433`, 106 tests, pushed); marshaller-finalize approach party-RATIFIED Round 5 (4/4, no impasse). Dev RED-first in flight against frozen real-shape fixtures, then integrated `studio-smoke-min`+tejal live re-prove → dual-gate CLOSE.** Sequenced AHEAD of Leg-1b.
