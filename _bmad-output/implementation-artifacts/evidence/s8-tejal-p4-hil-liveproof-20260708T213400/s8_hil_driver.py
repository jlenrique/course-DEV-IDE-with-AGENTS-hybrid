"""S8 Tejal Part-4 HIL liveproof driver — AFK operator stand-in.

Authentic E2E against local Marcus-SPOC / production trial runtime:
...
facts: dict = {
    "story": "S8-tejal-p4-hil-composed-proof",
...
# Honest S8 claim gate (driver-local; party still owns final close)
claim_ok = (
...
facts["s8_hil_proof_driver_claim_ok"] = bool(claim_ok)
facts["s8_complete_requires_party"] = True
facts["note"] = (
    "Driver claim_ok means compose+G0-HIL+trial-start+bundle binding succeeded "
    "and the gate walk ran without driver exception. Full S8-complete still "
    "requires evidence review + BMAD party concurrence. Part-4 thinness may "
    "honestly surface as G0R inadequacy or later error-pause — that is not "
    "fabricated away."
)
