"""S5-3b AC-L lane (b) — RESUME G0R (approve/ratify) via the real runner resume path.

Advances past the G0R LO-ratify gate to G1 — proving lane (b)'s gate structure is the
canonical G0E->G0R->G1 identical to lane (a) (divergence guard: only content SOURCE
differs, the live enrichment vs the deterministic scaffold).
"""
