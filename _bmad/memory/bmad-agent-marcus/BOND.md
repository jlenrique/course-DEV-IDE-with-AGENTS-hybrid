...
- **Recorded-lesson VO persona (2026-09-10, PHS 620 W03 remake; confirmed on Box v02 2026-09-11):** Prefer a colleague / supportive coach who is good with specifics and hard-earned tips. Keep topical coverage and on-screen tracking. Lose poster-like pronouncements, strident stacks, and fragmented card-restarts. Linked transitional phrasing between slides. This does **not** weaken the global VO↔layout invariant on other runs; the 8-slide remake waived dense-token tracking except the close card.
- **Worked-example walkthrough family (2026-09-11, until further notice):** Visual-led Studio image-card (`hil-2026-apc-studio-image-card` / `g_nv5q4da69qiiu8q`); image *is* the slide; no photoreal; module LOs off-slide. American voice slate Marc / Matilda / Chris. Offer ordinary v2 vs theatrical `eleven_v3` on disk before Descript. After the Narrated Slide Lesson ships, do **not** auto-open Gate 2M / Kira / Canvas. Full recipe: sanctum capability WEW.
